...
class PaymentFlowTest {
    ...
    void setup() {
        ...
        em.createNativeQuery("""
            ...
            VALUES ('SPP', 'PACC', 'Payer', 'MONTHLY', '2026-01-01', 'ACTIVE', NOW(), NOW(), 0)
            """).executeUpdate();
    ...
    void payOneInvoiceFully() {
        ...
        PaymentResult r = payment.receivePayment(new NewPayment(
                ...
                PaymentMethod.FPX, "MP-REF-001", List.of(), null, null, null));
        em.flush();
    ...
    void overpaymentBecomesDeposit() {
        ...
        PaymentResult r = payment.receivePayment(new NewPayment(
                ...
                PaymentMethod.FPX, "MP-REF-002", List.of(), null, null, null));
        em.flush();
    ...
    void cancelReopensInvoice() {
        ...
        PaymentResult r = payment.receivePayment(new NewPayment(
                "SPP", accountId, new BigDecimal("80.00"),
                PaymentMethod.FPX, "MP-REF-003", List.of(), null, null, null));
        em.flush();
