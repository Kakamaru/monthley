...
class PaymentReportTest {
    ...
    void setup() {
        ...
        em.createNativeQuery("""
            ...
            VALUES ('SPR', 'RACC', 'Report Payer', 'MONTHLY', '2026-01-01', 'ACTIVE', NOW(), NOW(), 0)
            """).executeUpdate();
    ...
    void invoiceVsReceipt() {
        ...
        payment.receivePayment(new NewPayment("SPR", accountId, new BigDecimal("40.00"),
                PaymentMethod.FPX, "MP-A", List.of(janInvId), null, null, null));
        payment.receivePayment(new NewPayment("SPR", accountId, new BigDecimal("40.00"),
                PaymentMethod.CASH, "MP-B", List.of(janInvId), null, null, null));
        em.flush();
